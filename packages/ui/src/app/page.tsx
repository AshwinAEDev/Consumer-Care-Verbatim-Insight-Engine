...
import type { Insight } from "@ccvie/core";
...
import { getInsights, getVerbatimsByIds } from "@/lib/queries";

function averageLeadTime(insights: readonly Insight[]): number | null {
...
function peakConfidence(insights: readonly Insight[]): number | null {
